...
class source:
    def __init__(self):
        self.base_link = 'http://www.filmeshare.net'
        self.search_link = '/?s='
...
##                except: titulo = title
            ...
            for results in result:
                ...
                try: result_imdb = client.parseDOM(result_imdb, 'span', attrs = {'class': 'dato'})[0]
                except: result_imdb = ''
...
##        sources = []
##        sources.append({'source': 'Filmeshare', 'quality': 'HD', 'provider': 'Filmeshare'+url, 'url': url, 'direct': False, 'debridonly': False})
        ...
        try:
            ...
            if 'EPISODIO' in url:
                ...
                for host_url in hosts:
                    ...
                    sources.append({'source': host, 'quality': quality, 'provider': 'Filmeshare'+audio_filme, 'url': host_url, 'direct': False, 'debridonly': False})
