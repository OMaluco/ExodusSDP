...
class source:
    def __init__(self):
        ...
        self.base_link = 'http://cinematuga.top'
        self.search_link = '/?s='
...
##        sources.append({'source': 'gvideo', 'quality': 'HD', 'provider': 'CinematugaHD'+url, 'url': url, 'direct': False, 'debridonly': False})
        try:
            ...
            for results in result:
                ...
                sources.append({'source': host+audio_filme, 'quality': quality, 'provider': 'CinematugaHD', 'url': host_url, 'direct': False, 'debridonly': False})                
